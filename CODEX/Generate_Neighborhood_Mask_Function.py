...
for name in sample_names:
	print(name)
	clusters = 'Annotation_Masks/Filtered_Neighborhood'+name+'_neighborhoods_Pix4_11172023.csv' 
	mask = '/mnt/isilon/tan_lab/parvaresha/Pediatric_Glioma/pHGG_Oldridge_Samples/'+name+'/mesmer/Pix4/segmentation_nuclear_dil.tif'
	output = 'Annotation_Masks/FULL_Filtered_Neighborhoods_'+name+'_Pix4_Mask.tiff'
