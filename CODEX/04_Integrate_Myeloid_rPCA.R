...
combined0 <- subset(combined, subset=annotations_lv1_full=="Myeloid Cells")
...
saveRDS(integrated_seurat, paste0("Myeloid_Seurat_Objects/Myeloid_",pix,"_rPCA_1_",as.character(sketch_count),"_CLR2_NoCC_DAPI.RDS"))

#Some plots 
#integrated_seurat <- readRDS(paste0("Myeloid_Seurat_Objects/Myeloid_",pix,"_rPCA_1_",as.character(sketch_count),"_CLR2_NoCC_DAPI.RDS"))
...
#Print pdf  
pdf(paste0("Marker_Plots_Myeloid_",pix,"_",as.character(sketch_count),"_CLR2_NoCC_DAPI.pdf"))
...
saveRDS(integrated_seurat, paste0("Myeloid_Seurat_Objects/Myeloid_",pix,"_rPCA_2_",as.character(sketch_count),"_CLR2_NoCC_DAPI.RDS"))
...
for(name in sample_names){
  ...
  write.csv(annotations_df, file = paste0("Annotation_Masks/Myeloid_",name,"_",annotations_col,"_",pix,"_NoCC_DAPI.csv"))
}
...
integrated_seurat <- RenameIdents(integrated_seurat, 
                                  "0" = "Proneural Tumor Cells", 
                                  "1" = "Macrophages",
                                  "2" = "Macrophages/Tumor Cells",
                                  "3" = "CD163+CD206+ Macrophages",
                                  "4" = "Microglia",
                                  "5" = "HLA-hi Macrophages",
                                  "6" = "Neutrophils",
                                  "7" = "RBCs",
                                  "8" = "Tumor/Vascular",
                                  "9" = "Neutrophils",
                                  "10" = "Neutrophils",
                                  "11" = "HLA-hi Macrophages",
                                  "12" = "Intermediate Tumor Cells",
                                  "13" = "Macrophages",
                                  "14" = "Neutrophils",
                                  "15" = "Neutrophils", 
                                  "16" = "Artifact",
                                  "17" = "HLA-hi Macrophages", 
                                  "18" = "Artifact",
                                  "19" = "Intermediate Tumor Cells",
                                  "20" = "Intermediate Tumor Cells")
...
saveRDS(integrated_seurat, "Annotated_Seurat_Objects/Annotated_Myeloid_10162023.RDS")
...
#Read latest file 
integrated_seurat <- readRDS("Myeloid_Seurat_Objects/Myeloid_Pix4_rPCA_2_50000_CLR2_NoCC_DAPI.RDS")
